          ...
          <div className="calendar_table-row d-flex" key={week}>
            {[...Array(7)].map((_, day) => {
              if (week === 0 && day < thisFirstDayOfWeek) {
                ...
                return (
                  <div
                    className="calendar_table-data pb-5 is-disabled"
                    key={day}
                  >
                ...
                return (
                  <div
                    className="calendar_table-data pb-5 js_calendar-date"
                    key={day}
                  >
                    <span className="calendar_date bg-primary text-white">
                      {num}
                    </span>
                ...
                dayCount++;
                return (
                  <div className="calendar_table-data pb-5" key={day}>
                    <span className="calendar_date">{num}</span>
  ...
  return (
    <>
      {events.map((event) => {
        ...
        const eventTime = `${String(eventDate.getHours()).padStart(
          2,
          "0"
        ...
        if (
          ...
          return (
            <span
              key={id}
              className="badge calendar_event"
